<script lang="ts">
	...
	export let variant: ArticleDisplayProps['variant'];
	export let image: ArticleDisplayProps['image'];
	export let title: ArticleDisplayProps['title'];
	export let description: ArticleDisplayProps['description'];
	export let url: ArticleDisplayProps['url'];
	export let articleSource: ArticleDisplayProps['articleSource'];
</script>
